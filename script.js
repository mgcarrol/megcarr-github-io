...
navProjects.onmouseover = function(){
  navProjects.style.textDecoration = 'underline';
  navProjects.style.color = '#1fc2d3';
};
navProjects.onmouseout = function() {
  navProjects.style.textDecoration = '';
  navProjects.style.color = '';
};
